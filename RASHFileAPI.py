# temp backup
# {"/": "Welcome to RASH's filesystem! This is the root directory. You can use the 'ls' command to list files and directories, 'cd <directory>' to change directories, and 'cat <file>' to view file contents.", "/hi/": "hello", "/hi/hello/": "Hello there! This is a subdirectory under /hi.", "/hi/hello/world/": "You've reached the world directory! This is a subdirectory under /hi/hello.", "/hi/hello/world/file.txt": "This is a text file located at /hi/hello/world/file.txt. You can read its contents using the 'cat' command."}
